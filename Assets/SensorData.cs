...
public class SensorData : MonoBehaviour
{
    ...
    IEnumerator enableLocation() {
        ...
        else
        {
            ...
            Text ctext = GameObject.Find("gpsTextElement").GetComponent<Text>();
            ctext.text = "Location: " + Input.location.lastData.latitude + " " + Input.location.lastData.longitude + " " + Input.location.lastData.altitude;
        }
